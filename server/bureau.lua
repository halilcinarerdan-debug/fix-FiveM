...
CreateThread(function()
    Wait(1500)
    if type(Matrix.RemoveBot) == 'function' and not Matrix.Bureau.__RemoveBotWrapped then
        Matrix.Bureau.__RemoveBotWrapped = true
